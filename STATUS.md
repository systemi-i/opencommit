...
- a machine-readable catalog of 72 diagnostics;
- canonicalization and hashing requirements;
- a synthetic Core-L2 worked package;
- a 26-expectation schema-mutation suite;
...
Implementations should describe themselves as testing or implementing the ICSL v0.1 candidate and should identify the artifact, version, conformance class, suite version, and result involved. Unqualified claims of being “ICSL compliant” are premature. See [Claims and Maturity](05-public-review/claim-guardrails.md).
